...
<code>wildfly-8/standalone/configuration/standalone.xml</code> file and add the <code>&lt;single-sign-on/&gt;</code> tag under the undertow sybsystem server configuration.
